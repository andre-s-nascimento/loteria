...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link" href="novaaposta.html">
					<i class="fas fa-fw fa-cube"></i> <span>Nova Aposta</span>
			</a></li>

			<li class="nav-item"><a class="nav-link" href="apostas.html">
					<i class="fas fa-fw fa-cubes"></i> <span>Apostas</span>
			</a></li>
		</ul>
		<!-- End of Sidebar -->
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">Nome
									Usuário</span> <img class="img-profile rounded-circle"
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div
						class="d-sm-flex align-items-center justify-content-between mb-4 no-print">
					...
					<div
						class="d-sm-flex align-items-center justify-content-between mb-4 only-print">
					...
					<div class="row">
						...
						<div class="col-xl-8 col-lg-7">
							<div class="card shadow mb-4">
								...
								<div
									...
									<h6 class="m-0 font-weight-bold text-primary">Ganhos por
										mês</h6>
						...
						<div class="col-xl-4 col-lg-5">
							<div class="card shadow mb-4">
								...
								<div
									class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">Acerto das
										Apostas</h6>
									<div class="dropdown no-arrow">
										<a class="dropdown-toggle" href="#" role="button"
											id="dropdownMenuLink" data-toggle="dropdown"
								...
								<div class="card-body">
									...
									<div class="mt-4 text-center small">
										<span class="mr-2"> <i
											class="fas fa-circle text-primary"></i> Ganhou
										</span> <span class="mr-2"> <i
											class="fas fa-circle text-success"></i> Perdeu
										</span>
									</div>
								</div>
							</div>
			...
			<footer class="sticky-footer bg-white">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>Copyright &copy; BLH - A Ferreira Nascimento Company
							- 2021</span>
					</div>
				</div>
			</footer>
